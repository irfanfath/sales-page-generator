export default function GradientTemplate({ generated }: any) {
  return (
    <div className="rounded-3xl p-8 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white space-y-10 min-h-full animate-fadein">
      ...
      <div className="grid md:grid-cols-2 gap-4">{generated.features.map((f:string,i:number)=><div key={i} className="p-5 rounded-2xl bg-white/20">{f}</div>)}</div>
