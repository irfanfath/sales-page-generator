export const mockGenerateSalesCopy = async (data: any) => {
  ...
  return {
    ...
    description: `${data.productName} helps eliminate the pain of ${data.description} by delivering a modern and highly optimized solution.`,
    benefits: [
    ...
    socialProof: 'Trusted by over 12,000+ users worldwide.',
